...
<div class="container">
	...
	<div class="jumbotron">
	  ...
	  @else
		  ...
		  <p>In January, you will be able to vote for two videos. If your video gets the most votes, then you win an iPad!&nbsp;<span class="text-danger"><i class="glyphicon glyphicon-gift"></i></span></p>
		  <p>If you want to add your own science video here for everyone to watch and vote for, click here:&nbsp;<a class="btn btn-primary" href="/video/upload" role="button">Add my video!</a></p>
	  @endif
	</div>
</div>
