...
<div class="container">
	...
	<div class="jumbotron">
	  ...
	  <p>These videos all answer a big science question, and are all less than a minute long. Watch them, and if you find one you really like, you can click the heart button <span class="text-primary"><i class="glyphicon glyphicon-heart"></i></span> to give it your vote! The video with the most votes will win an amazing prize! <span class="text-danger"><i class="glyphicon glyphicon-gift"></i></span></p>
	  <br>
